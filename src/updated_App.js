    ...
    >
      ...
      >
        ...
        <div className="mt-2 text-center text-[10px] text-gray-400 px-4">
          Disclaimer: This calculator is intended for educational and illustrative purposes only. It does not constitute financial advice. Trading involves risk and may not be suitable for all investors. You are solely responsible for your own trading decisions.
          <br />
